...
export const Bitcoin = () => {
    return(
        <div className="bitcoin-main">
            ...
            <p className="bitcoin-para">sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse </p>

            <h3>Already Holding Bitcoin ? </h3>
            <img className="bitcoin-img" alt="bitcoin" src={bitcoin} ></img>
            <p className="bitcoin-para"></p>
